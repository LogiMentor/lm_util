...
architecture a_rtl of lm_util_lfsr is

  --function for Linear Feedback Shift Register.
...
begin
  ...
  assert (g_data_w <= 168) report "g_data_w out of supported range in f_lfsr" severity failure;
